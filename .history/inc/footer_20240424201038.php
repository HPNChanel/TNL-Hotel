...
<h6 class="text-center bg-dark text-white p-3 m-0">Created by HPN(Phuc Nguyen): CEO TNL Hotel, Data Scientist <br>
  Tinh Nguyen(Nguyen Van Tinh): Flutter Developer <br>
  Tran Nhat Long: Tester
</h6>
